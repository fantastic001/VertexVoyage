...
\begin{frame}{Zaključak}
    \begin{itemize}
        \item Pokazano je da:
        \begin{itemize}
            \item Paralelna implementacija algoritma brža od serijske, nakon određenog broja šetnji, dok zadržava kvalitet rekonstrukcije grafa
            \item Klasterovanje dobijeno paralelnim ugrađivanjem slično klasterovanju dobijenom serijskim ugrađivanjem
        \end{itemize}
